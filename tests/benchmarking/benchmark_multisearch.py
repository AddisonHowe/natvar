...
@pytest.mark.parametrize("batch_size", [100, 200, 400, 800, 3200])
def test_static_multisearch_matrix_batched_manual_vmap(
    genomes_fpath, queries_fpath, name, batch_size
):
    ...
    func_name = "static_multisearch_matrix_batched_manual_vmap"
    static_multisearch_matrix_batched = jax.vmap(
        static_search_matrix_batched, (None,0,None,None,None)
    )
    func = eqx.filter_jit(static_multisearch_matrix_batched)
