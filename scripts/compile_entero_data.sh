...
#=============================================================================
#
# FILE: compile_entero_data.sh
#
# USAGE: compile_entero_data.sh
#
# DESCRIPTION: Compile data corresponding to order Enterobacterales.
#
# EXAMPLE: sh scripts/compile_entero_data.sh
#=============================================================================

outdir=data/dataset_entero
